...
## Lectura del mapa
El mapa muestra:
- total de creadoras del corpus;
- creadoras georreferenciadas con evidencia;
- creadoras pendientes;
- porcentaje de cobertura geográfica;
- lista visible de perfiles pendientes.

La ausencia de marcadores no se corrige inventando lugares: se presenta como indicador de avance de investigación.
